...
__run_post_install() {
  ...
  [ -f "$APPDIR/gitmessage" ] && [ ! -f "$HOME/.config/secure/git/message" ] && cp_rf "$APPDIR/gitmessage" "$HOME/.config/secure/git/message" || true
  [ -f "$APPDIR/gitignore" ] && [ ! -f "$HOME/.config/secure/git/ignore" ] && cp_rf "$APPDIR/gitignore" "$HOME/.config/secure/git/ignore" || true
  [ -f "$APPDIR/gitattributes" ] && [ ! -f "$HOME/.config/secure/git/attributes" ] && cp_rf "$APPDIR/gitattributes" "$HOME/.config/secure/git/attributes" || true
  [ -f "$APPDIR/git-credentials" ] && [ ! -f "$HOME/.config/secure/git/credentials" ] && mv_f "$APPDIR/git-credentials" "$HOME/.config/secure/git/credentials" || true
  [ -f "$HOME/.git-credentials" ] && [ ! -f "$HOME/.config/secure/git/credentials" ] && mv_f "$HOME/.git-credentials" "$HOME/.config/secure/git/credentials" || true
  [ -L "$HOME/.git-credentials" ] && unlink "$HOME/.git-credentials" || true
